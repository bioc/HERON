...
base Bioconductor. The components are a sequence *data.frame* or *matrix* where rows 
are amino acid sequences of the peptide binding probe and the columns are
